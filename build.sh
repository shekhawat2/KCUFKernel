...
export CROSS_COMPILE=/home/anansingh17/linaro7/bin/aarch64-linux-gnu-
export ARCH=arm64
...
echo "Making Zip"
zip -r KCUF-N-$BUILD_TIME *
cd ..
mv anykernel/KCUF-N-$BUILD_TIME.zip kernel/KCUF-N-$BUILD_TIME.zip
gdrive upload kernel/KCUF-N-$BUILD_TIME.zip
